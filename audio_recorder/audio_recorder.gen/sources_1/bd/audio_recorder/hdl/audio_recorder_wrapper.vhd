...
--Command     : generate_target audio_recorder_wrapper.bd
--Design      : audio_recorder_wrapper
...
entity audio_recorder_wrapper is
  port (
    BCLK : out STD_LOGIC;
...
end audio_recorder_wrapper;

architecture STRUCTURE of audio_recorder_wrapper is
...
audio_recorder_i: component audio_recorder
     port map (
      BCLK => BCLK,
