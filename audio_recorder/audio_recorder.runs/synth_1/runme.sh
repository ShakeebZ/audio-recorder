...
HD_PWD='S:/Documents/ENSC452/Milestone0/audio_recorder/audio_recorder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_recorder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_recorder_wrapper.tcl
